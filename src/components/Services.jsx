            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start border-t border-white/10 pt-12 group-hover:border-white transition-colors duration-700">
                ...
                <div className="lg:col-span-5 text-center md:text-left">
                   <h3 className="text-3xl md:text-[30px] lg:text-[40px] font-extrabold uppercase tracking-tighter leading-none group-hover:translate-x-4 transition-transform duration-700">
                     {service.title}
                   </h3>
                </div>

                {/* Description & Tags */}
                <div className="lg:col-span-6 flex flex-col gap-8 lg:pl-12 text-center md:text-left">
                   <p className="text-base md:text-xl font-medium leading-relaxed text-white/50 group-hover:text-white/90 transition-colors duration-500">
                     {service.description}
                   </p>
